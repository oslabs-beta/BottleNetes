...
import { PromQLController } from "controller-types";

const promQLController: PromQLController = {
  generateQueryAllPodsStatus: async (_req, res, next) => {
  ...
  generateQueryAllPodsRequestLimit: async (_req, res, next) => {
  ...
  generateQueryResourceUsage: async (_req, res, next) => {
  ...
  generateQueryLatencyAppRequest: async (_req, res, next) => {
...
export default promQLController;
