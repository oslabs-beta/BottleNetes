...
export const generateQueryAllPodsStatus = async (
  _req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const generateQueryAllPodsRequestLimit = async (
  _req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const generateQueryResourceUsage = async (
  _req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const generateQueryLatencyAppRequest = async (
  _req: Request,
  res: Response,
  next: NextFunction,
) => {
