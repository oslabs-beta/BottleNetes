...
import { ResponseParsingController } from "controller-types";

const responseParsingController: ResponseParsingController = {
...
export default responseParsingController;