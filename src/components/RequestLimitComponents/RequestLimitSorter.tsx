  ...
  return (
    <div className="flex justify-end">
      <select
        ...
        className="-mb-4 mt-4 w-full rounded-lg border-2 border-transparent bg-slate-200 px-3 py-2 text-sm font-semibold text-slate-500 transition duration-200 hover:brightness-90 dark:bg-slate-800 dark:text-slate-300"
      >
