  ...
  return (
    <div id="pod-restart">
      <button
        ...
        className="w-full rounded-lg border-2 border-transparent bg-slate-200 px-3 py-2 text-sm text-slate-500 font-semibold transition duration-200 hover:brightness-90 active:brightness-105 dark:text-slate-300 dark:bg-slate-800"
      >
        Restart Pod
      </button>
      <div
